...
// import MonthlyTask from '../Monthly/ndex';
...
const Tasks = ()=>{
  navigated.navigate('todaytask')
}
const  MonthlyTask = ()=>{
  navigated.navigate('Monthlytask')
}
const handle = ()=>{
  navigated.navigate('Project')
}
  return (
    <ScrollView style={styles.container}>
      ...
      <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} style={styles.horizontalScrollView}>
        ...
        >
          ...
          <View style={styles.cardFooter}>
            <Image style={styles.cardAvatar} source={require('../../../assets/card1.jpeg')} />
            <Image style={styles.cardAvatar} source={require('../../../assets/card2.jpeg')} />
            <Image style={styles.cardAvatar} source={require('../../../assets/card3.jpeg')} />
          </View>
        </TouchableOpacity>
      ...
      <TouchableOpacity onPress={Tasks} style={styles.task}>
      ...
      <TouchableOpacity onPress={handle} style={styles.task}>
